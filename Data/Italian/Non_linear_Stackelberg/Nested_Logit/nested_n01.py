...
def getData():
    ...
    # Nested model stucture
    # In our case, we have the following nests: IC_CAR, PLANE, HSR
    # mu is the membership parameter of each nest. Since the model was estimated for business and non-business customers,
    # we have 2 values of mu.
    dict['mu'] = [[1.35, 2.39], [1.54, 1.22], [1.75, 1.95]]
    # mapping between each nest and the alternatives inside the nest
