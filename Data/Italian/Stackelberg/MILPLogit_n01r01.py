...
def getData(dict):
    ...
    # Capacities
    #                              CAR   PLANE  IC_1   IC_2   AV_1   AV_2   NTV_1  NTV_2
    dict['capacity'] = np.concatenate(( dict['N'] * np.ones(dict['I_opt_out']), np.array([1.0, dict['N'], 2.0, dict['N']]))) # Availability for each alternative (opt-out always available)
