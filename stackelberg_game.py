...
import numpy as np
# data
import Data.Italian.Stackelberg.MILPLogit_n40r50_calibrate as data_file
...
class Stackelberg:
    ...
    def solveModel(self, model):
        ...
        try:
            ...
            model.parameters.mip.display.set(3)
            model.solve()
...
if __name__ == '__main__':
    ...
    dict = data_file.getInfo()
    dict = data_file.getData(dict)
