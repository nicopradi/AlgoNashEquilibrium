...
import Data.Italian.Fixed_Point.ProbLogit_n01r01_calibrate as df2
    ...
    def __init__(self, **kwargs):
        ''' Construct a Fixed_point game
            KeywordArgs:
                ...
                wAft_precomputed wAft value when is was possible to guess its value [list]
