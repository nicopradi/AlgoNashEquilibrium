...
def getData(dict):
    ...
    dict['BUSINESS'] =   [1, 1, 1, 1, 1, 0, 0, 1, 1, 1]
    ...
    # Capacities
    #                              CAR   PLANE  IC_1   IC_2   AV_1   AV_2   NTV_1  NTV_2
    dict['capacity'] = np.concatenate(( dict['N'] * np.ones(dict['I_opt_out']), np.array([1, dict['N'], 1, dict['N']]))) # Availability for each alternative (opt-out always available)
